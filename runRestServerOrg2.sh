...
composer card create -p ~/.composer/cards/PeerAdminOrg2@hlfv1/connection.json -u restadminOrg2 -n $BUSSINESS_NAME -c restadminOrg2/admin-pub.pem -k restadminOrg2/admin-priv.pem
rm -R restadminOrg2
